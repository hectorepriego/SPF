     ...
     <div class="container" align="center">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form enctype="multipart/form-data" action="controllers/controller.persona.editor.php" method="post" id="form">
                            ...
                            <a href="?page=edit-persona" class="btn btn-dark">Regresar</a>
                            <a>&nbsp</a>
         ...
         <!-- Modal Agregar ubicacion -->
                <div class="modal fade" id="agregarextension" tabindex="-1" role="dialog" aria-labelledby="extensionModalLabel"
                    ...
                    <div class="modal-body">
                        <form action="controllers/controller.extension_modal_edit.php" method="post" id="form2"><br>            
                        <div class="form-group" align="left">
