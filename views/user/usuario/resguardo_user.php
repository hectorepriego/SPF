...
<?php include $templates_navbar_user ?>
    ...
    <!--Inicio de la barra de componentes-->
            ...
            <div class="col-md-3 col-sm-3 card-header" align="right">
                 <form class="form-inline mt-3 mt-md-0" action="?page=user-resguardo" method="post">
            ...
            <div class="col-md-1 col-sm-1 card-header" align="left">
                <div class="form-group">
                    <a class="btn btn-sm btn-primary" href='?page=user-resguardo-editar'>Nuevo</a>
                </div>
            </div>
    ...
    <?php $resguard=$_POST["Buscar"]?> 
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped table table-sm" id="myTable">
                            ...
                            if($resguard){
                                $resguardo->getWhere("(num_resguardo LIKE '%{$resguard}%' OR nombre_completo LIKE '%{$resguard}%' OR created_at LIKE '%{$resguard}%' ) AND id_usuario = {$_SESSION['usuario']->id_usuario}"); 
                             //echo "filtro"        
                            }
                            else{
                            $resguardo->getResguardo();
                            }
                            ...
                            ;
                                echo "<td>
                                    <a href='?page=user-resguardo-editar&id=$row->id_resguardo'class='fas fa-edit'></a>
                                </td>";

                                echo "<td>
                                    <a href='?page=user-resguardo-detalle&idR=$row->id_resguardo'class='fas fa-archive'></a>
                                </td>";

                                echo "<td>
                                    <a href='?page=user-resguardo-asignado&idR=$row->id_resguardo'class='fas fa-eye'></a>
                                </td>";     
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="controllers/controller.user_resguardo.php" method="post" id="form2">
                            <div class="form-group">
