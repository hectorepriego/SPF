...
?>
                ...
                <div class="card">
                    ...
                    <div class="row">
                        <div class="container">
                          <div class="row">
                            <div class="col-6">
                        <form action="controllers/controller.resguardo_detalle_user.php" method="post" id="form">   <input type="hidden" class="form-control" name="num_resguardo" value="<?=$idR?>">
    ...
    <div class="card-body">
        ...
        <center><a href="?page=user-resguardo" class="btn btn-primary" text-align="center">Guardar</a></center>
                    </div>
                </div>
            </div>
        <br>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="controllers/controller.resguardo_detalle_user.php" method="post" id="form2">
