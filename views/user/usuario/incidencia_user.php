    ...
    <div class="card-body">
        ...
        <!--Mitad de la barra lado Derecho 1/2-->
            <div class="col-md-3 col-sm-3 card-header" align="right">
                 <form class="form-inline mt-3 mt-md-0" action="?page=user-incidencia" method="post">
        ...
        <!--Mitad de la barra lado Derecho 1/2-->
            <div class="col-md-1 col-sm-1 card-header" align="left">
                <div class="form-group">
                        <a class="btn btn-sm btn-primary" href='?page=user-incidencia-editar'>Nuevo</a>
                   </div>
            </div>
    ...
    <?php $inciden=$_POST["Buscar"]?>  
                    ...
                    <div class="card-body">
                        ...
                        <style>
                            ...
                            if($inciden){
                                $incidencia->getWhere("(asunto LIKE '%{$inciden}%' OR departamento LIKE '%{$inciden}%' OR fecha_hora LIKE '%{$inciden}%' )AND id_usuario = {$_SESSION['usuario']->id_usuario}"); 
                             //echo "filtro"        
                            }
                            else{
                            ...
                            ;
                                 echo "<td>
                                    <a href='?page=user-incidencia-editar&id=$row->id_incidencias'class='fas fa-edit'></a>
                                </td>";

                                echo "<td> 
                                <a href='?page=user-incidencia-ver&id=$row->id_incidencias'class='linkborrar fas fa-eye'></a>
                                </td>";
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="controllers/controller.user_incidencia.php" method="post" id="form2">
                            <div class="form-group">
