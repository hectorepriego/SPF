...
<?php include $templates_navbar_adm ?>
    ...
    <!--Inicio de la barra de componentes-->
            ...
            <div class="col-md-1 col-sm-1 card-header" align="left">
                <div class="form-group">
                   <a class="btn btn-sm btn-primary" href='?page=adm-categoria-editar''>Nuevo</a> 
                </div>
            </div>
    <!--Termino de la barra de componentes-->
                    <div class="card-body">
                        ...
                        <table class="table table-striped table table-sm" id="myTable">
                            ...
                            ;
                                echo "<td>
                                    <a href='?page=adm-categoria-editar&id=$row->id_categoria'class='fas fa-edit'></a>
                                    
                                    <a href='$row->id_categoria' data-toggle='modal' data-target='#deleteModal' class='linkborrar fas fa-trash-alt'></a>
                                </td>";
                                echo "</tr>";
                            }
                            ?>
                        ...
                        <script> 
                            $(document).ready(function(){
                              $("#buscar").on("keyup", function() {
                                ...
                                $("#Searchcategoria tr").filter(function() {
