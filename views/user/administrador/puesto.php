...
?>
<?php include $base_dir . "/models/model.puesto.php";?>
...
<?php include $templates_navbar_adm ?>
    ...
    <!--Inicio de la barra de componentes-->
            ...
            <div class="col-md-1 col-sm-1 card-header" align="left">
                <div class="form-group">
                   <a class="btn btn-sm btn-primary" href='?page=adm-puesto-editar'>Nuevo</a> 
                </div>
            </div>
    <!--Termino de la barra de componentes-->

                    <div class="card-body">
                        <h5 style="text-align:center">Puestos</h5>
                        <table class="table table-striped table table-sm" id="myTable">
                            ...
                            <tbody id="Searchpuesto">
                            <?php
                            $puesto->getAll();
                            while ($row = $puesto->next()) {
                                echo "<tr>";
                                echo "<td>$row->puesto</td>";
                            ;
                                echo "<td>
                                    <a href='?page=adm-puesto-editar&id=$row->id_puesto'class='fas fa-edit'></a>
                                    <a>&nbsp</a>
                                    <a href='$row->id_puesto' data-toggle='modal' data-target='#deleteModal' class='linkborrar fas fa-trash-alt'></a>
                                </td>";
                                echo "</tr>";
                            }
                            ?>
                        ...
                        <script> 
                            $(document).ready(function(){
                              $("#buscar").on("keyup", function() {
                                ...
                                $("#Searchpuesto tr").filter(function() {
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteModalLabel">Borrar Puesto</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="controllers/controller.puesto.php" method="post" id="form2">
                            <div class="form-group">
                                <h3 class="text-danger">¿Estas seguro de borrar este Puesto?</h3>
