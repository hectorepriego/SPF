        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card" style="width:900px">
                    <div class="card-body">
                        <form enctype="multipart/form-data" action="controllers/controller.documento.php" method="post" id="form">
                           ...
                           <label>Archivo</label>  
                            ...
                            <a  href="?page=adm-documento" class="btn btn-dark">Regresar</a>
                            <a>&nbsp</a>
