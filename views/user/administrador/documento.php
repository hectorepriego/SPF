...
<?php include $templates_navbar_adm ?>
    ...
    <!--Inicio de la barra de componentes-->
            ...
            <div class="col-md-3 col-sm-3 card-header" align="right">
                 <form class="form-inline mt-3 mt-md-0" action="?page=adm-documento" method="post">
            ...
            <div class="col-md-1 col-sm-1 card-header" align="left">
                <div class="form-group">
                    <a class="btn btn-sm btn-primary" href='?page=adm-documento-editar'>Nuevo</a>
                </div>
            </div>
      ...
      <?php $document=$_POST["Buscar"]?> 
                    ...
                    <div class="card-body">
                        ...
                        <style>
                            ...
                            if($document){
                                $documento->getWhere("folio LIKE '%{$document}%' OR tipo_documento LIKE '%{$document}%' OR fecha_doc LIKE '%{$document}%' OR nombre_completo LIKE '%{$document}%'"); 
                             //echo "filtro"        
                            }
                            else{
                                $documento->getAll();
                            ...
                            ;
                                echo "<td>
                                    <a href='?page=adm-documento-editar&id=$row->id_documento'class='fas fa-edit'></a>
                                </td>";
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="controllers/controller.documento.php" method="post" id="form2">
                            <div class="form-group">
