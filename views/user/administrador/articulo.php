    ...
    <!--Inicio de la barra de componentes-->
            ...
            <div class="col-sm-8 col-md-8 card-header" align="left">
                <div class="form-group">
                    <a class="btn btn-sm btn-danger" href='?page=open-pdf-articulos'target='_blank'>Exportar PDF</a>
                     <a>&nbsp</a>
            ...
            <div class="col-md-3 col-sm-3 card-header" align="right">
                 <form class="form-inline mt-3 mt-md-0" action="?page=adm-articulo" method="post">
            ...
            <div class="col-md-1 col-sm-1 card-header" align="left">
                <div class="form-group">
                    <a class="btn btn-sm btn-primary" href='?page=adm-articulo-editar'>Nuevo</a> 
                </div>
            </div>
                    ...
                    <tbody id="Searcharticulos">
                        ...
                        if($articu){
                            $articulo->getWhere("nombre_articulo LIKE '%{$articu}%' OR inv_interno LIKE '%{$articu}%' OR inv_externo LIKE '%{$articu}%' OR num_serie LIKE '%{$articu}%'
                                OR marca LIKE '%{$articu}%' OR estatus LIKE '%{$articu}%' OR categoria LIKE '%{$articu}%' OR nombre_completo LIKE '%{$articu}%' OR ubicacion LIKE '%{$articu}%'"); 
                         //echo "filtro"        
                        }
                        else{
                            $articulo->getAll();
                        ...
                        while ($row = $articulo->next()) {
                            ...
                            ;
                            echo "<td>
                                 <a href='?page=adm-articulo-editar&id=$row->id_articulo'class='fas fa-edit'></a>
                                </td>";

                            echo "<td> 
                                <a href='?page=adm-articulo-ver&id=$row->id_articulo'class='linkborrar fas fa-eye'></a>
                                </td>";
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="controllers/controller.articulo.php" method="post" id="form2">
                            <div class="form-group">
