                ...
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <div class="form-group text">
                            <textarea type="text" class="form-control" name="ubicacion" rows="2" value="<?= $articulo->data->ubicacion?>" readonly><?php echo $articulo->data->ubicacion?></textarea>
                        </div>
                    </div>
                    <div class="col-3">
                        <!--Espacio Vacio-->
                            ...
                            ?>                            
                            <a href="?page=adm-articulo" class="btn btn-dark btn-sm">Regresar</a>
                    </div>
                </div>
            </div>
        </div>
